...
$(document).ready(function ()
{
    ...
    $('#tagsCreator .glyphicon-ok').on("click", function ()
    {
...
class Tags
{
    static tagList:Array<String> = [] /*present.tags*/;
    
    public static newTag(tagName:String):void
    {
        Tags.tagList.push(tagName);
        Tags.displayTag(tagName);
    }
    
    public static displayTag(tagName:String):void
    {
        $("#tagsNav").append('<li role="presentation" id="tag_' + tagName + '" class="navTag">' +
